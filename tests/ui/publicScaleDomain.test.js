...
describe("publicScaleDomain", () => {
  it("resolve o limite da escala e monta a proxima versao das secoes", () => {
    ...
    expect(buildPublicScaleLimitMessage(1)).toBe("Este nome já está em uma vaga desta escala.");
    expect(buildPublicScaleLimitMessage(2)).toBe("Este nome já atingiu o limite de vagas desta escala.");
  });
