...
- `frontend/src/features/admin/MessagingTemplatesBlock.jsx`
  Composicao visual do editor e da lista de modelos de mensagens administrativas; estado e confirmacao ficam em `useMessagingTemplatesController.js`.
...
- `frontend/src/features/admin/MessagingPresetsBlock.jsx`
  Composicao visual do editor e da lista de presets de pessoas para mensagens administrativas; estado e confirmacao ficam em `useMessagingPresetsController.js`.
...
- `frontend/src/features/admin/useMessagingPresetsController.js`
  Controller local do bloco de presets de pessoas: estado, filtro, ordenacao, submit e confirmacao.
- `frontend/src/features/admin/useMessagingTemplatesController.js`
  Controller local do bloco de modelos de mensagem: estado, submit e confirmacao.
...
- `frontend/src/features/admin/ExternalBasesEditorPanel.jsx`
  Composicao visual dos blocos basico e de sincronizacao do editor de bases externas.
- `frontend/src/features/admin/ExternalBasesCoreEditorPanel.jsx`
  Bloco basico do editor de bases externas.
- `frontend/src/features/admin/ExternalBasesSyncEditorPanel.jsx`
  Bloco de sincronizacao e acoes do editor de bases externas.
...
- `frontend/src/features/admin/FieldCatalogEditorPanel.jsx`
  Composicao visual das secoes basicas e avancadas do editor de campos base.
- `frontend/src/features/admin/FieldCatalogCoreEditorPanel.jsx`
