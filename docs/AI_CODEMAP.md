...
- `frontend/src/lib/appBootstrap.js`
  Helpers puros do bootstrap inicial do frontend, incluindo normalizacao do payload, selecao do formulario ativo, operacoes reutilizaveis de lista e listas aninhadas no estado, ordenacao de eventos e atualizacao de metricas de formularios.
