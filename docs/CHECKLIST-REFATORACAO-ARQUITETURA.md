...
- [ ] Remover a dependencia circular entre `frontend/src/components/ui.jsx` e `frontend/src/components/publicUi.jsx`; `ui.jsx` deve ficar apenas com primitives genericos, e `publicUi.jsx` deve ser a fonte de verdade dos componentes publicos.
