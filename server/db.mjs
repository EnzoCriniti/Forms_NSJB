/**
 * @file server/db.mjs
 * @summary Conexao e schema SQLite.
 * @responsibility Inicializar banco, schema base e helpers JSON/data.
 */
...
const migrations = [
  {
    ...
    apply: () => {
      if (!hasColumn("forms", "results_config_json")) {
        db.exec("ALTER TABLE forms ADD COLUMN results_config_json TEXT NOT NULL DEFAULT '{}'");
      }

      if (!hasColumn("presets", "results_config_json")) {
  ...
  },
  {
    ...
    apply: () => {
      if (!hasColumn("field_catalog", "grid_schema_json")) {
