...
export const useCreateFormController = ({
  ...
  return {
    ...
    presenceSectionProps: {
      ...
      addField: fieldHandlers.addField,
      addGridCol: fieldHandlers.addGridCol,
      addGridRow: fieldHandlers.addGridRow,
      addOpen,
      applyFieldCatalog: fieldHandlers.applyFieldCatalog,
      applyScalePreset: fieldHandlers.applyScalePreset,
      ...
      handleRemoveField: fieldHandlers.handleRemoveField,
      handleToggleFieldShow: fieldHandlers.handleToggleFieldShow,
      hasPrimaryLinkedField: derived.hasPrimaryLinkedField,
      inp,
      inpSm,
      ...
      nType,
      nValidation,
      openNewFieldDraft: fieldHandlers.openNewFieldDraft,
      people,
      removeGridCol: fieldHandlers.removeGridCol,
      removeGridRow: fieldHandlers.removeGridRow,
      resetFieldDraft: fieldHandlers.resetFieldDraft,
      resultsConfig,
      setFieldMode: fieldHandlers.setFieldMode,
      setFieldType: fieldHandlers.setFieldType,
      setNLabel: fieldHandlers.setNLabel,
      setNRequired: fieldHandlers.setNRequired,
      setNValidation: fieldHandlers.setNValidation,
      setResultsConfig,
      startEditField: fieldHandlers.startEditField,
      totalizableFields: derived.totalizableFields,
      updateGridCol: fieldHandlers.updateGridCol,
      updateGridRow: fieldHandlers.updateGridRow,
    },
    footerProps: {
      format,
      isEditingExistingForm,
