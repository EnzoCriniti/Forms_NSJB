...
export const GUIDE_ARTICLES = [
  ...
  },
  {
    ...
    keywords: ["presenca", "formulario", "campos", "resposta", "faltantes", "nucleo", "geral"],
    ...
    possibilities: ["Usar campos do catalogo ou configurar campos especificos.", "Definir um seletor de pessoa principal e seletores secundarios.", "Ativar totalizacoes, resultados publicos e controle de faltantes.", "Escolher o modo Nucleo ou Geral conforme a origem das pessoas."],
    workflow: ["Escolha Presenca ao criar o formulario.", "Defina modo, titulo, status e campos.", "Configure a pessoa principal e as opcoes de resultados.", "Salve, revise a previa e compartilhe o link quando o formulario estiver aberto."],
    technical: "O modo Nucleo exige um campo principal ligado a base central de socios. O modo Geral bloqueia essa base e atende publicos externos. A configuracao de resultados fica em resultsConfig; o controle de faltantes depende de showLinkedRoster e do vinculo principal de pessoa.",
  },
  {
    id: "escala-organ",
    category: "Formularios",
  ...
  },
  {
    ...
    keywords: ["responder", "preencher", "link", "publico", "editar resposta", "compartilhar"],
    ...
    possibilities: ["Compartilhar um link direto de evento e formulario.", "Localizar uma resposta existente quando a regra do formulario permitir.", "Exibir aviso de formulario fechado sem perder o acesso a resultados publicos habilitados.", "Usar o mesmo formulario em telas pequenas."],
    workflow: ["Copie o link exibido no formulario ou evento.", "A pessoa informa os dados solicitados e envia.", "Se houver resposta anterior identificavel, o fluxo oferece a edicao.", "Erros de envio aparecem em um aviso sem deslocar os campos."],
    technical: "As rotas publicas canonicas usam #/formularios/<id> ou #/eventos/<evento>/<formulario>. O backend valida cada valor com as mesmas regras estruturais usadas pelo editor, evitando respostas fora do contrato do campo.",
  },
  {
    ...
    possibilities: ["Filtrar por coluna, valor e grau.", "Ordenar linhas e ajustar o zoom da tabela, inclusive por gesto de toque.", "Comparar respostas recebidas com a base vinculada quando o controle de faltantes estiver ativo.", "Exportar os dados visiveis em CSV."],
    ...
    technical: "O controller combina respostas, configuracao do formulario e base vinculada para montar linhas e totais. A lista de faltantes so existe quando showLinkedRoster esta ativo. A exportacao e gerada no frontend com os mesmos valores exibidos na tabela.",
  },
  {
    id: "planilha-organ",
    category: "Resultados",
