 ...
 * @responsibility Configuracao global, CRUD de modelos e presets de pessoas.
 */
...
const ConfigBlock = ({ messagingConfig, onSave }) => {
...
const TemplatesBlock = ({ templates, onSave, onDelete }) => {
...
const PresetsBlock = ({ presets, people, onSave, onDelete }) => {
...
export const MessagingSettingsPanel = ({
  ...
  <section className="settings-grid">
    <ConfigBlock messagingConfig={messagingConfig} onSave={onSaveMessagingConfig} />
    <div style={{ gridColumn: "1 / -1", borderTop: `1px solid ${COLORS.borderLight}`, marginTop: 8 }} />
    <div style={{ gridColumn: "1 / -1" }}>
      <TemplatesBlock templates={messageTemplates} onSave={onSaveMessageTemplate} onDelete={onDeleteMessageTemplate} />
    </div>
    <div style={{ gridColumn: "1 / -1", borderTop: `1px solid ${COLORS.borderLight}`, marginTop: 8 }} />
    <div style={{ gridColumn: "1 / -1" }}>
      <PresetsBlock presets={personPresets} people={people} onSave={onSavePersonPreset} onDelete={onDeletePersonPreset} />
    </div>
  </section>
);
