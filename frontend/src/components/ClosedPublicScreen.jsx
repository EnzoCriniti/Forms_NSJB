...
export const ClosedPublicScreen = ({ form, onBack, actionLabel, actionHref, message, title = "Formulário fechado", readingControls }) => (
  <div>
    ...
    <div className="public-closed-card" style={{ background: COLORS.surface, border: `1px solid ${COLORS.border}`, borderRadius: 18, padding: "36px 24px", textAlign: "center" }}>
      ...
      <p style={{ margin: "0 auto", maxWidth: 460, fontSize: 13, lineHeight: 1.55, color: COLORS.textSecondary }}>{message?.includes("resultados") ? message : (form?.closingText || message || "Este formulário não está mais aceitando respostas.")}</p>
